    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          ...
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Transfer and conversion of sales
          </a>
        ...
        <div className="col-4 p-5 mt-2 mb-2 ">
          <h4 className="">
            <i class="fa-solid fa-file-invoice"></i>Your Zerodha account
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
           Margin/Average,Product and order types
          </a>
          <br />
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Kite Web and Mobile
        ...
        <div className="col-4 p-5 mt-2 mb-2">
          <h4 className="">
            <i class="fa-solid fa-money-bill-1-wave"></i>Funds
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Adding Funds
          </a>
